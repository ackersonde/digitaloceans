...
sudo ip6tables -A INPUT -s $NEW_SERVER_IPV6 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT && \
sudo ip6tables -D INPUT -s $OLD_SERVER_IPV6 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT"
